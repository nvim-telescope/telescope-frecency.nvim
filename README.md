...
A tagged release `v1.0.0` is published and it drops the support for Neovim 0.9.x.
If you are still using Neovim 0.9.x, use `v0.9.0` tag for your favorite plugin
manager.
